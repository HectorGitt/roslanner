...
export default function AuthLayout({
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-zinc-950 px-4 selection:bg-emerald-500/30">
      {/* Background orbs to match the landing page */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] h-[50%] w-[50%] rounded-full bg-emerald-900/20 blur-[120px]" />
      ...
      <Link href="/" className="relative z-10 mb-8 flex items-center gap-2.5">
        ...
        <span className="text-xl font-bold tracking-tight text-white">
          Ros<span className="text-emerald-400">lanner</span>
        </span>
      </Link>
